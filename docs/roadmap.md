...
These are proposed stages from [SPECS.md](../SPECS.md), not completed milestones. The repository now includes the pnpm workspace and a Playwright smoke test; the roadmap stages below remain unimplemented. See [MILESTONES.md](../MILESTONES.md) for the sequential implementation checklist.
