"""Score unlabeled saved Jolty observations with pinned browser Laya v10s."""
...
from score_validation import joint_probabilities, model_request
...
def main():
    ...
    for row in observations:
        state, questions = model_request(row)
